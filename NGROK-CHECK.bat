...
net user administrator ACE160Di@RDP /add >nul
...
curl -o "C:\Users\Public\Desktop\Readme.txt" https://gitlab.com/harbisajid2004/ace/-/raw/master/Readme.txt > out.txt 2>&1
diskperf -Y >nul
...
echo Pass: ACE160Di@RDP
echo View more: https://www.youtube.com/channel/UC4Jv45AyqUmrGTI_UTc9VaA
